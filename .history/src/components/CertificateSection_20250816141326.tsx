...
export function CertificateSection() {
  ...
  // Hitung durasi animasi berdasarkan jumlah sertifikat
  // (misalnya, 8 detik per sertifikat)
  const animationDuration = certificates.length * 8 + "s";
  ...
  return (
    <section id="certificates" className="py-28 sm:py-36">
      ...
      <div className="relative w-full overflow-hidden">
        {/* --- PERUBAHAN DI SINI --- */}
        <div
          className={cn(styles.marqueeContainer, styles.animate)}
          style={{ animationDuration }} // Terapkan durasi dinamis
        >
