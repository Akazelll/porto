    ...
    <section id="about" className="container px-4 sm:px-6 py-24 sm:py-32">
      <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-5 lg:gap-16">
        ...
        <div className="text-center lg:col-span-3 lg:text-left">
          <h2 className="mb-6 text-3xl font-bold tracking-tight sm:text-4xl md:text-5xl inline bg-gradient-to-r from-purple-400 to-blue-600 bg-clip-text text-transparent">
            About Me
          </h2>
