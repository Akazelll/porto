...
export function HeroSection() {
  return (
    <section
      id="home"
      className="container flex flex-col items-center justify-center gap-10 text-center"
      // Tinggi minimal disesuaikan agar tidak terlalu memakan tempat di mobile
