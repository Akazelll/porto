      ...
      <div className="mx-auto grid w-full max-w-7xl gap-10 px-6 lg:grid-cols-2 lg:gap-14 lg:px-8">
        <ScrollFloat>
          <GlowCard className="p-6 sm:p-8">
            ...
            <h2 className="mt-3 text-3xl font-bold tracking-tight sm:text-4xl"><GradientHeading text="Passionate developer crafting thoughtful digital products." /></h2>
        ...
        <div className="space-y-6">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {Object.entries(skillGroups).map(([group, stacks], index) => (
              <ScrollFloat key={group} delay={0.12 + index * 0.04}>
                <GlowCard className="p-4 transition hover:-translate-y-1">
